...
export default function MedicalMalpracticeSub() {
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "medical-negligence": {
      ...
      descAr: "محامي إهمال طبي في المملكة العربية السعودية — تمثيل قانوني متخصص في مطالبات الأخطاء الطبية والتعويض. استشارة أونلاين 24/7.",
    ...
    "surgical-errors": {
      ...
      descAr: "محامي أخطاء جراحية في المملكة — مطالبات تعويض عن الأخطاء الجراحية والإهمال الطبي. استشارة أونلاين 24/7.",
    ...
    "misdiagnosis": {
      ...
      descAr: "محامي تشخيص خاطئ في المملكة — تعويض عن أخطاء التشخيص والتشخيص المتأخر. استشارة أونلاين 24/7.",
    ...
    "hospital-liability": {
      ...
      descAr: "محامي مسؤولية مستشفى في المملكة — مطالبات ضد المستشفيات ومزودي الرعاية الصحية. استشارة أونلاين 24/7.",
    ...
    "pharmaceutical-claims": {
      ...
      descAr: "محامي أضرار دوائية في المملكة — تعويض عن أخطاء الأدوية ومسؤولية المستحضرات الدوائية. استشارة أونلاين 24/7.",
    ...
    "dental-malpractice": {
      ...
      descAr: "محامي أخطاء طب الأسنان في المملكة — تعويض عن الإهمال في طب الأسنان وفشل الزراعة. استشارة أونلاين 24/7.",
    ...
    "healthcare-regulatory": {
      ...
      descAr: "محامي دفاع تنظيمي طبي في المملكة — الدفاع أمام الهيئة السعودية للتخصصات الصحية ووزارة الصحة. استشارة أونلاين 24/7.",
    ...
    "patient-rights": {
      ...
      descAr: "محامي حقوق المرضى في المملكة — حقوق الموافقة المستنيرة والخصوصية الطبية والتعويض. استشارة أونلاين 24/7.",
