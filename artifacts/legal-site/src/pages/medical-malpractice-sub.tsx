...
export default function MedicalMalpracticeSub() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الأخطاء الطبية" : "Medical Malpractice", item: "https://qanoni.com/services/medical-malpractice" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/medical-malpractice/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/medical-malpractice/${subId}`,
