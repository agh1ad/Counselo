...
export default function MedicalMalpracticeSub() {
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "medical-negligence": {
      desc: "Medical negligence lawyer in Saudi Arabia — expert legal representation for medical malpractice claims and compensation. Online consultation 24/7.",
      descAr: "محامي إهمال طبي في المملكة العربية السعودية — تمثيل قانوني متخصص في مطالبات الأخطاء الطبية والتعويض. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "medical negligence lawyer Saudi Arabia, medical malpractice KSA, hospital negligence claim Saudi, doctor negligence compensation Saudi Arabia",
      kwAr: "محامي إهمال طبي السعودية, تعويض خطأ طبي المملكة, مسؤولية مستشفى المملكة, إهمال طبي الرياض",
    },
    "surgical-errors": {
      desc: "Surgical error lawyer in Saudi Arabia — compensation claims for surgical malpractice and negligence. Expert healthcare law representation. Online consultation 24/7.",
      descAr: "محامي أخطاء جراحية في المملكة — مطالبات تعويض عن الأخطاء الجراحية والإهمال الطبي. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "surgical error lawyer Saudi Arabia, surgical malpractice KSA, wrong site surgery Saudi, surgical negligence compensation Saudi Arabia",
      kwAr: "محامي خطأ جراحي السعودية, تعويض خطأ جراحي المملكة, إهمال جراحي الرياض",
    },
    "misdiagnosis": {
      desc: "Misdiagnosis lawyer in Saudi Arabia — compensation for diagnostic errors, delayed diagnosis, and failure to diagnose in Saudi Arabia. Online consultation 24/7.",
      descAr: "محامي تشخيص خاطئ في المملكة — تعويض عن أخطاء التشخيص والتشخيص المتأخر. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "misdiagnosis lawyer Saudi Arabia, wrong diagnosis KSA, delayed diagnosis claim Saudi, failure to diagnose compensation Saudi Arabia",
      kwAr: "محامي تشخيص خاطئ السعودية, تعويض خطأ تشخيص المملكة, تشخيص متأخر الرياض",
    },
    "hospital-liability": {
      desc: "Hospital liability lawyer in Saudi Arabia — claims against hospitals and healthcare providers for negligence. Expert medical law representation. Online consultation 24/7.",
      descAr: "محامي مسؤولية مستشفى في المملكة — مطالبات ضد المستشفيات ومزودي الرعاية الصحية. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "hospital liability lawyer Saudi Arabia, hospital negligence claim KSA, healthcare provider liability Saudi, suing hospital Saudi Arabia",
      kwAr: "محامي مسؤولية مستشفى السعودية, دعوى ضد مستشفى المملكة, مسؤولية مزود رعاية صحية",
    },
    "pharmaceutical-claims": {
      desc: "Pharmaceutical injury lawyer in Saudi Arabia — medication error compensation and drug liability claims. Expert healthcare law. Online consultation 24/7.",
      descAr: "محامي أضرار دوائية في المملكة — تعويض عن أخطاء الأدوية ومسؤولية المستحضرات الدوائية. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "pharmaceutical injury lawyer Saudi Arabia, medication error claim KSA, drug liability Saudi Arabia, prescription error compensation Saudi",
      kwAr: "محامي أضرار دوائية السعودية, تعويض خطأ دواء المملكة, مسؤولية دوائية الرياض",
    },
    "dental-malpractice": {
      desc: "Dental malpractice lawyer in Saudi Arabia — compensation for dental negligence, implant failure, and dental treatment errors. Online consultation 24/7.",
      descAr: "محامي أخطاء طب الأسنان في المملكة — تعويض عن الإهمال في طب الأسنان وفشل الزراعة. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "dental malpractice lawyer Saudi Arabia, dental negligence KSA, dental implant failure claim Saudi, dentist negligence compensation Saudi Arabia",
      kwAr: "محامي أخطاء طب أسنان السعودية, إهمال طب أسنان المملكة, فشل زراعة أسنان الرياض",
    },
    "healthcare-regulatory": {
      desc: "Healthcare regulatory defense lawyer Saudi Arabia — SCFHS and MOH disciplinary defense for healthcare professionals. Online consultation 24/7.",
      descAr: "محامي دفاع تنظيمي طبي في المملكة — الدفاع أمام الهيئة السعودية للتخصصات الصحية ووزارة الصحة. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "healthcare regulatory lawyer Saudi Arabia, SCFHS disciplinary defense KSA, MOH investigation Saudi, medical license defense Saudi Arabia",
      kwAr: "محامي دفاع تنظيمي طبي السعودية, الدفاع أمام الهيئة الصحية, وزارة الصحة تحقيق",
    },
    "patient-rights": {
      desc: "Patient rights lawyer Saudi Arabia — informed consent, medical privacy, and compensation claims for healthcare rights violations. Online consultation 24/7.",
      descAr: "محامي حقوق المرضى في المملكة — حقوق الموافقة المستنيرة والخصوصية الطبية والتعويض. استشارة استجابة احترافية خلال 24 ساعة عبر واتساب أو البريد الإلكتروني — قانوني المملكة العربية السعودية.",
      kw: "patient rights lawyer Saudi Arabia, informed consent violation KSA, medical privacy Saudi, patient compensation Saudi Arabia",
      kwAr: "محامي حقوق مرضى السعودية, موافقة مستنيرة المملكة, حقوق المريض الرياض",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الأخطاء الطبية" : "Medical Malpractice", item: "https://counselo.com/services/medical-malpractice" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://counselo.com/services/medical-malpractice/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://counselo.com/services/medical-malpractice/${subId}`,
  ...
  return (
    <div className="w-full bg-background min-h-screen">
      <SEOHead
        title={data.seoTitle}
        description={seoDescription}
        canonical={`/services/medical-malpractice/${subId}`}
          ...
          <div className="lg:col-span-4">
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              <div className="bg-primary p-8 text-white">
                ...
                <Link href={`/contact?service=medical-malpractice-${subId}`}>
