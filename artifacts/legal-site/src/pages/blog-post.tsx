...
export default function BlogPost() {
  ...
  const ui = {
    ...
    ar: {
      ...
      consultDesc:
        region === "syr"
          ? "يقدم كاونسلو استشارات سرية عبر واتساب أو البريد الإلكتروني — دون الحاجة لزيارة مكتب. من تأسيس المحامي والمستشار القانوني عمر البغدادي — خبرة قانونية تزيد على 30 عاماً."
          : "يقدم كاونسلو استشارات سرية عبر واتساب أو البريد الإلكتروني — دون الحاجة لزيارة مكتب. من تأسيس المحامي والمستشار القانوني عمر البغدادي — خبرة قانونية سعودية تزيد على 30 عاماً.",
            ...
            <div className="sticky top-28">
              <div className="bg-primary text-white p-6 mb-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    href="mailto:info@counselo-legal.com"
