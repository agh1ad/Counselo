...
export default function CriminalLawSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/criminal-law" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "criminal-defense": {
      ...
      descAr: "محامي دفاع جزائي في المملكة العربية السعودية — تمثيل متخصص أمام المحاكم الجزائية السعودية. دفاع عن الأفراد والشركات في القضايا الجزائية. استشارة أونلاين 24/7.",
    ...
    "bail-release": {
      ...
      descAr: "محامي طلبات الكفالة والإفراج في المملكة — تقديم طلبات كفالة عاجلة أمام المحاكم الجزائية السعودية. استشارة أونلاين 24/7.",
    ...
    "criminal-appeals": {
      ...
      descAr: "محامي استئناف جزائي في المملكة — الطعن في الأحكام الجزائية أمام محكمة الاستئناف والمحكمة العليا. استشارة أونلاين 24/7.",
    ...
    "cybercrime-cases": {
      ...
      descAr: "محامي جرائم معلوماتية في المملكة — الدفاع وفق نظام مكافحة الجرائم المعلوماتية. استشارة أونلاين 24/7.",
    ...
    "financial-crimes": {
      ...
      descAr: "محامي جرائم مالية في المملكة — الدفاع في قضايا الاحتيال والاختلاس وغسل الأموال أمام المحاكم السعودية. استشارة أونلاين 24/7.",
    ...
    "drug-offenses": {
      ...
      descAr: "محامي قضايا المخدرات في المملكة — دفاع جزائي متخصص في قضايا المخدرات والمؤثرات العقلية. استشارة أونلاين 24/7.",
    ...
    "criminal-investigations": {
      ...
      descAr: "محامي مرحلة التحقيق الجزائي في المملكة — تمثيل المشتبه بهم أمام النيابة العامة خلال التحقيق. استشارة أونلاين 24/7.",
    ...
    "public-order": {
      ...
      descAr: "محامي قضايا الإخلال بالنظام العام في المملكة — الدفاع في قضايا الآداب العامة والتحريض وخطاب الكراهية. استشارة أونلاين 24/7.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الجزائي" : "Criminal Law", item: "https://qanoni.com/services/criminal-law" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/criminal-law/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/criminal-law/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/criminal-law" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
      ...
      <section className="relative py-16 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/services/criminal-law" className="inline-flex items-center text-white/60 hover:text-white text-sm mb-8 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              ...
              <div className="bg-card border border-border p-6">
                ...
                <div className="space-y-1">
                  {otherAreas.map((area) => (
                    <Link key={area.id} href={`/services/criminal-law/${area.id}`} className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-primary/5 hover:text-primary transition-colors group text-sm">
