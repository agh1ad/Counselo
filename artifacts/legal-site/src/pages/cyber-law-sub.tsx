...
export default function CyberLawSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/cyber-law" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "cybercrime-defense": {
      ...
      descAr: "محامي جرائم معلوماتية في المملكة — دفاع متخصص وفق نظام مكافحة الجرائم المعلوماتية (م/17). تمثيل عاجل. استشارة أونلاين 24/7.",
    ...
    "data-protection": {
      ...
      descAr: "محامي حماية بيانات في المملكة — الامتثال لنظام حماية البيانات الشخصية وبرامج الخصوصية ومشورة هيئة البيانات. استشارة أونلاين 24/7.",
    ...
    "online-fraud": {
      ...
      descAr: "محامي احتيال إلكتروني في المملكة — الدفاع في الغش الرقمي واسترداد خسائر الضحايا. استشارة أونلاين 24/7.",
    ...
    "hacking-defense": {
      ...
      descAr: "محامي قضايا اختراق في المملكة — الدفاع في قضايا الوصول غير المشروع وانتهاكات الأمن السيبراني. استشارة أونلاين 24/7.",
    ...
    "online-defamation": {
      ...
      descAr: "محامي تشهير إلكتروني في المملكة — الدفاع في التشهير الرقمي وحماية السمعة. نظام الجرائم المعلوماتية ووسائل التواصل الاجتماعي. استشارة أونلاين 24/7.",
    ...
    "ecommerce-disputes": {
      ...
      descAr: "محامي تجارة إلكترونية في المملكة — نزاعات الأعمال الإلكترونية ومطالبات المستهلكين والامتثال لنظام التجارة الإلكترونية. استشارة أونلاين 24/7.",
    ...
    "digital-privacy": {
      ...
      descAr: "محامي خصوصية رقمية في المملكة — حماية حقوق الخصوصية وانتهاكات نظام حماية البيانات والمشورة التنظيمية. استشارة أونلاين 24/7.",
    ...
    "it-contracts": {
      ...
      descAr: "محامي عقود تقنية المعلومات في المملكة — نزاعات اتفاقيات التكنولوجيا وعقود البرمجيات والخدمات الرقمية. استشارة أونلاين 24/7.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الجرائم المعلوماتية" : "Cyber & IT Law", item: "https://qanoni.com/services/cyber-law" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/cyber-law/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/cyber-law/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/cyber-law" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
      ...
      <section className="relative py-16 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/services/cyber-law" className="inline-flex items-center text-white/60 hover:text-white text-sm mb-8 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              ...
              <div className="bg-card border border-border p-6">
                ...
                <div className="space-y-1">
                  {otherAreas.map((area) => (
                    <Link key={area.id} href={`/services/cyber-law/${area.id}`} className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-primary/5 hover:text-primary transition-colors group text-sm">
