...
export default function ImmigrationLawSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/immigration-law" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "iqama-residency": {
      ...
      descAr: "محامي إقامة في المملكة العربية السعودية — نزاعات تجديد الإقامة والرفض وحقوق إقامة المقيمين الأجانب. استشارة أونلاين 24/7.",
    ...
    "work-visas": {
      ...
      descAr: "محامي تأشيرة عمل في المملكة — نزاعات تصاريح العمل وامتثال نطاقات وتصاريح العمل. استشارة أونلاين 24/7.",
    ...
    "kafala-transfer": {
      ...
      descAr: "محامي نقل كفالة في المملكة — نزاعات نقل الكفالة وبلاغات الهروب الكاذبة. استشارة عاجلة أونلاين 24/7.",
    ...
    "deportation-defense": {
      ...
      descAr: "محامي دفاع ضد الترحيل في المملكة — تمثيل قانوني عاجل ضد أوامر الترحيل والطرد. استشارة أونلاين 24/7.",
    ...
    "family-visas": {
      ...
      descAr: "محامي تأشيرة أسرة في المملكة — نزاعات إقامة التابعين ولم شمل الأسرة. استشارة أونلاين 24/7.",
    ...
    "premium-residency": {
      ...
      descAr: "محامي إقامة مميزة سعودية — استشارات طلب الإقامة المميزة (الكارت الأخضر السعودي) وتقييم الأهلية. استشارة أونلاين 24/7.",
    ...
    "business-visas": {
      ...
      descAr: "محامي تأشيرة أعمال في المملكة — تأشيرة المستثمر وتأشيرة الزيارة التجارية ومتطلبات الدخول التجاري. استشارة أونلاين 24/7.",
    ...
    "immigration-violations": {
      ...
      descAr: "محامي مخالفات إقامة في المملكة — الدفاع في مخالفات الإقامة والعمل غير المرخص وتسوية الأوضاع. استشارة عاجلة أونلاين 24/7.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الإقامة والهجرة" : "Immigration Law", item: "https://qanoni.com/services/immigration-law" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/immigration-law/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/immigration-law/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/immigration-law" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
      ...
      <section className="relative py-16 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/services/immigration-law" className="inline-flex items-center text-white/60 hover:text-white text-sm mb-8 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              ...
              <div className="bg-card border border-border p-6">
                ...
                <div className="space-y-1">
                  {otherAreas.map((area) => (
                    <Link key={area.id} href={`/services/immigration-law/${area.id}`} className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-primary/5 hover:text-primary transition-colors group text-sm">
