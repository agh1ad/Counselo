...
export default function CompaniesLawSub() {
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "company-formation-disputes": {
      desc: "Company formation disputes & incorporation nullity legal advice in Saudi Arabia. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "share-equity-disputes": {
      desc: "Share & equity ownership dispute legal advice in Saudi Arabia — LLC quotas, JSC shares, ownership rights. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "partner-shareholder-disputes": {
      desc: "Partner & shareholder dispute legal advice in Saudi Arabia — deadlock, oppression, breach of duty. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "director-liability": {
      desc: "Director & board member liability claims in Saudi Arabia — breach of fiduciary duty, mismanagement & fraud. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "general-assembly-disputes": {
      desc: "General assembly & partner resolution dispute legal advice in Saudi Arabia. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "assembly-resolution-nullity": {
      desc: "Assembly resolution nullity & annulment claims in Saudi Arabia — challenging unlawful company resolutions. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "capital-change-disputes": {
      desc: "Capital increase & decrease dispute legal advice in Saudi Arabia — protecting shareholder rights. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "profit-distribution-disputes": {
      desc: "Profit distribution & dividend dispute legal advice in Saudi Arabia — enforcing shareholder rights. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "conflict-of-interest": {
      desc: "Conflict of interest & corporate opportunity disputes in Saudi Arabia — director misconduct & self-dealing. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "director-removal-disputes": {
      desc: "Director & board member removal dispute legal advice in Saudi Arabia — wrongful dismissal & reinstatement. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "company-records-access": {
      desc: "Company records access & disclosure claims in Saudi Arabia — enforcing shareholder inspection rights. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "share-transfer-disputes": {
      desc: "Share sale & transfer dispute legal advice in Saudi Arabia — pre-emption rights, forced sale & ownership transfer. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "partner-entry-exit": {
      desc: "Partner entry & exit dispute legal advice in Saudi Arabia — forced buyout, deadlock exit & valuation. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "merger-conversion-disputes": {
      desc: "Company merger, conversion & demerger dispute legal advice in Saudi Arabia — minority protection & valuation. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "company-dissolution-liquidation": {
      desc: "Company dissolution & liquidation dispute legal advice in Saudi Arabia — creditor rights & asset distribution. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "liquidator-liability": {
      desc: "Liquidator liability dispute legal advice in Saudi Arabia — challenging misconduct & misappropriation. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "shareholder-compensation-claims": {
      desc: "Shareholder & company compensation claims in Saudi Arabia — recovering losses from director misconduct. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "family-company-disputes": {
      desc: "Family company dispute legal advice in Saudi Arabia — inheritance, management conflict & governance. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "shareholder-agreements-disputes": {
      desc: "Shareholder & partner agreement dispute legal advice in Saudi Arabia — breach, enforcement & interpretation. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "articles-of-association-disputes": {
      desc: "Articles of association & company statute violation legal advice in Saudi Arabia — breach of constitutional documents. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
