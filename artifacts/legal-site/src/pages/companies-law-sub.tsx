...
export default function CompaniesLawSub() {
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "company-formation-disputes": {
      desc: "Company formation disputes & incorporation nullity legal advice in Saudi Arabia. Online consultation via WhatsApp or email, 24/7.",
      descAr: "استشارة قانونية في منازعات تأسيس الشركة وبطلان التأسيس بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "share-equity-disputes": {
      desc: "Share & equity ownership dispute legal advice in Saudi Arabia — LLC quotas, JSC shares, ownership rights. Online consultation, 24/7.",
      descAr: "استشارة قانونية في منازعات الحصص والأسهم وملكيتها بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "partner-shareholder-disputes": {
      desc: "Partner & shareholder dispute legal advice in Saudi Arabia — deadlock, oppression, breach of duty. Online consultation, 24/7.",
      descAr: "استشارة قانونية في منازعات الشركاء والمساهمين بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "director-liability": {
      desc: "Director & board member liability claims in Saudi Arabia — breach of fiduciary duty, mismanagement & fraud. Online consultation, 24/7.",
      descAr: "استشارة قانونية في دعاوى مسؤولية المديرين وأعضاء مجلس الإدارة بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "general-assembly-disputes": {
      desc: "General assembly & partner resolution dispute legal advice in Saudi Arabia. Online consultation via WhatsApp or email, 24/7.",
      descAr: "استشارة قانونية في منازعات قرارات الشركاء والجمعيات العامة بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "assembly-resolution-nullity": {
      desc: "Assembly resolution nullity & annulment claims in Saudi Arabia — challenging unlawful company resolutions. Online consultation, 24/7.",
      descAr: "استشارة قانونية في دعاوى بطلان أو إلغاء قرارات الجمعية بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "capital-change-disputes": {
      desc: "Capital increase & decrease dispute legal advice in Saudi Arabia — protecting shareholder rights. Online consultation, 24/7.",
      descAr: "استشارة قانونية في منازعات زيادة رأس المال أو تخفيضه بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "profit-distribution-disputes": {
      desc: "Profit distribution & dividend dispute legal advice in Saudi Arabia — enforcing shareholder rights. Online consultation, 24/7.",
      descAr: "استشارة قانونية في منازعات توزيع الأرباح بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "conflict-of-interest": {
      desc: "Conflict of interest & corporate opportunity disputes in Saudi Arabia — director misconduct & self-dealing. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات تعارض المصالح واستغلال الفرص التجارية بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "director-removal-disputes": {
      desc: "Director & board member removal dispute legal advice in Saudi Arabia — wrongful dismissal & reinstatement. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات عزل المدير أو عضو مجلس الإدارة بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "company-records-access": {
      desc: "Company records access & disclosure claims in Saudi Arabia — enforcing shareholder inspection rights. Online consultation, 24/7.",
      descAr: "استشارة قانونية في دعاوى الإفصاح والاطلاع على سجلات ووثائق الشركة بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "share-transfer-disputes": {
      desc: "Share sale & transfer dispute legal advice in Saudi Arabia — pre-emption rights, forced sale & ownership transfer. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات بيع الحصص أو التنازل عنها بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "partner-entry-exit": {
      desc: "Partner entry & exit dispute legal advice in Saudi Arabia — forced buyout, deadlock exit & valuation. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات دخول أو خروج الشريك بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "merger-conversion-disputes": {
      desc: "Company merger, conversion & demerger dispute legal advice in Saudi Arabia — minority protection & valuation. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات اندماج الشركات أو تحولها أو انقسامها بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "company-dissolution-liquidation": {
      desc: "Company dissolution & liquidation dispute legal advice in Saudi Arabia — creditor rights & asset distribution. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات انقضاء الشركة وتصفيتها بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "liquidator-liability": {
      desc: "Liquidator liability dispute legal advice in Saudi Arabia — challenging misconduct & misappropriation. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات مسؤولية المصفي بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "shareholder-compensation-claims": {
      desc: "Shareholder & company compensation claims in Saudi Arabia — recovering losses from director misconduct. Online, 24/7.",
      descAr: "استشارة قانونية في دعاوى التعويض عن الإضرار بالشركة أو الشركاء أو المساهمين بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "family-company-disputes": {
      desc: "Family company dispute legal advice in Saudi Arabia — inheritance, management conflict & governance. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات الشركات العائلية بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "shareholder-agreements-disputes": {
      desc: "Shareholder & partner agreement dispute legal advice in Saudi Arabia — breach, enforcement & interpretation. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات اتفاقيات الشركاء أو المساهمين بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
    ...
    "articles-of-association-disputes": {
      desc: "Articles of association & company statute violation legal advice in Saudi Arabia — breach of constitutional documents. Online, 24/7.",
      descAr: "استشارة قانونية في منازعات مخالفة عقد التأسيس أو النظام الأساسي للشركة بالمملكة. أونلاين عبر واتساب أو البريد الإلكتروني، 24/7.",
  ...
  const legalServiceSchema = {
    ...
    availableChannel: {
      "@type": "ServiceChannel",
      serviceUrl: "https://qanoni.com/contact",
      availableLanguage: ["Arabic", "English"],
    },
    url: `https://qanoni.com/services/companies-law/${subId}`,
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "نظام الشركات" : "Companies Law", item: "https://qanoni.com/services/companies-law" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/companies-law/${subId}` },
    ],
  };
