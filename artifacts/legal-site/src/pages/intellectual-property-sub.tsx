...
export default function IntellectualPropertySub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/intellectual-property" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "trademark-registration": {
      ...
      descAr: "محامي تسجيل علامات تجارية في المملكة — تقديم طلبات العلامات التجارية لدى هيئة الملكية الفكرية وحماية العلامة. استشارة أونلاين 24/7.",
    ...
    "patent-protection": {
      ...
      descAr: "محامي براءات اختراع في المملكة — إيداع البراءات وحمايتها وإنفاذها لدى هيئة الملكية الفكرية. استشارة أونلاين 24/7.",
    ...
    "copyright-disputes": {
      ...
      descAr: "محامي حقوق تأليف في المملكة — مطالبات انتهاك حقوق التأليف والدفاع عنها وحماية المصنفات الإبداعية. استشارة أونلاين 24/7.",
    ...
    "trade-secrets": {
      ...
      descAr: "محامي أسرار تجارية في المملكة — حماية المعلومات السرية وصياغة اتفاقيات السرية ومطالبات الاعتداء. استشارة أونلاين 24/7.",
    ...
    "ip-licensing": {
      ...
      descAr: "محامي ترخيص ملكية فكرية في المملكة — صياغة اتفاقيات ترخيص العلامات التجارية والبراءات وحقوق التأليف. استشارة أونلاين 24/7.",
    ...
    "brand-protection": {
      ...
      descAr: "محامي حماية العلامة التجارية في المملكة — مكافحة التقليد والتسجيل الجمركي والتقاضي في انتهاكات العلامات. استشارة أونلاين 24/7.",
    ...
    "ip-disputes": {
      ...
      descAr: "محامي تقاضي ملكية فكرية في المملكة — حسم نزاعات الملكية الفكرية وإنفاذها أمام المحاكم السعودية وهيئة الملكية الفكرية. استشارة أونلاين 24/7.",
    ...
    "ip-due-diligence": {
      ...
      descAr: "محامي العناية الواجبة للملكية الفكرية في المملكة — العناية الواجبة للملكية الفكرية في صفقات الاندماج والاستحواذ. استشارة أونلاين 24/7.",
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/intellectual-property" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
      ...
      <section className="relative py-16 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/services/intellectual-property" className="inline-flex items-center text-white/60 hover:text-white text-sm mb-8 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              ...
              <div className="bg-card border border-border p-6">
                ...
                <div className="space-y-1">
                  {otherAreas.map((area) => (
                    <Link key={area.id} href={`/services/intellectual-property/${area.id}`} className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-primary/5 hover:text-primary transition-colors group text-sm">
