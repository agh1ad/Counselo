...
const websiteSchema = {
  ...
  "description": "كاونسلو منصة قانونية إلكترونية ثنائية اللغة لمسائل السعودية وسوريا والإمارات، تقدم استشارات محددة الاختصاص ومراجعة مستندات وإرشاداً منظماً، مع وقت استجابة مستهدف بحسب النطاق والاستعجال وتوفر الخدمة.",
...
const organizationSchema = {
  ...
  "description": "كاونسلو منصة قانونية إلكترونية ثنائية اللغة يقودها المحامي والمستشار القانوني عمر البغدادي، وتتعامل مع المعلومات وفق التزامات السرية المهنية والخصوصية وحماية البيانات الواجبة التطبيق.",
  "founder": {
    ...OMAR_AL_BAGHDADI,
...
const FAQS = [
  ...
  { q: "كيف أبدأ استشارتي؟", a: "اختر السعودية أو سوريا أو الإمارات، ثم أرسل سؤالك عبر النموذج أو واتساب. نستهدف الرد خلال 24 ساعة بحسب نطاق المسألة ودرجة استعجالها." },
  ...
  return (
    <main className="w-full bg-background" dir="rtl" id="main-content">
      <Helmet>
        ...
        <title>كاونسلو | استشارة قانونية أونلاين — السعودية وسوريا والإمارات</title>
        <meta name="description" content="كاونسلو منصة قانونية إلكترونية ثنائية اللغة لمسائل السعودية وسوريا والإمارات، للاستشارة محددة الاختصاص ومراجعة المستندات والإرشاد المنظم." />
        ...
        <meta name="twitter:title" content="كاونسلو | استشارة قانونية أونلاين — السعودية وسوريا والإمارات" />
        <meta name="twitter:description" content="استشارة قانونية بالعربية والإنجليزية، مع استجابة مستهدفة بحسب النطاق والاستعجال وتوفر الخدمة." />
        ...
        <div className="relative mx-auto w-full max-w-[1380px]">
          <div className="mb-10 flex items-center justify-between border-b border-[#0d4a31]/15 bg-white px-4 pb-4 pt-3">
            <Link href="/sa/ar" aria-label="كاونسلو السعودية">
              <picture className="contents">
                ...
                <img
                  src={counseloLogo}
                alt="كاونسلو — استشارات قانونية أونلاين للسعودية وسوريا والإمارات"
                width="193"
                height="80"
                fetchPriority="high"
                decoding="async"
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20">
            <motion.div initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-2xl">
              <p aria-hidden="true" className="mb-6 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">
            ...
            <motion.div initial={false} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="lg:pt-14">
              <div className="mb-6 flex items-end justify-between gap-5">
                <div>
                  <p aria-hidden="true" className="mb-2 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">اختر نطاق قضائك</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  { href: "/sa/ar", flag: saudiFlag, flagWebp: saudiFlagWebp, label: "المملكة العربية السعودية", alt: "السعودية — استشارة قانونية", number: "٠١", dark: true },
                  { href: "/syr/ar", flag: syrianFlag, flagWebp: syrianFlagWebp, label: "سوريا", alt: "سوريا — استشارة قانونية", number: "٠٢", dark: false },
                  { href: "/uae/ar", flag: uaeFlag, flagWebp: undefined, label: "الإمارات العربية المتحدة", alt: "الإمارات — استشارة قانونية", number: "٠٣", dark: true },
      ...
      <section className="border-b border-[#0d4a31]/10 bg-white py-20 lg:py-24" aria-labelledby="platform-heading-ar">
        <div className="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            <div>
              <p aria-hidden="true" className="mb-4 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">منصة كاونسلو</p>
            ...
            <div className="space-y-5 text-base leading-8 text-muted-foreground sm:text-lg">
              ...
              <dl className="grid gap-3 pt-3 sm:grid-cols-2" aria-label="نطاق المنصة">
                ...
                ].map(([label, value]) => <div key={label} className="border-s-2 border-[#b58b32] bg-[#eef4f0] px-4 py-3"><dt><span className="sr-only">{label}</span><span aria-hidden="true" className="text-xs font-bold tracking-[0.1em] text-[#0d4a31]/65">{label}</span></dt><dd className="mt-1 text-sm leading-6 text-foreground">{value}</dd></div>)}
              </dl>
            </div>
          </div>
        </div>
      ...
      {comprehensiveConsultation && (
        <section className="border-b border-[#0d4a31]/10 bg-[#eef4f0] py-20 lg:py-24" aria-labelledby="consultation-package-heading-ar">
          <div className="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
              <div>
                <p aria-hidden="true" className="mb-4 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">حزمة الاستشارة</p>
        ...
        <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4">
            {[
              ...
              { stat: "3",        label: "ثلاث دول: السعودية وسوريا والإمارات" },
        ...
        <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8">
          <div className="grid items-start gap-14 lg:grid-cols-5 lg:gap-24">
            ...
            <motion.div initial={false} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="lg:col-span-3">
              <p aria-hidden="true" className="mb-4 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">عن كاونسلو</p>
                ...
                <div className="border-t border-white/20 pt-6">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "محامٍ أول ومستشار قانوني في المملكة وسوريا والإمارات",
      ...
      <section className="border-y border-[#0d4a31]/10 bg-white py-24 lg:py-32" aria-labelledby="jurisdictions-heading-ar">
        <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="mb-16 max-w-3xl">
            <p aria-hidden="true" className="mb-4 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">اختر الاختصاص القضائي</p>
      ...
      <section className="bg-[#eef4f0] py-24 lg:py-32" aria-labelledby="faq-heading-ar">
        <div className="mx-auto grid max-w-[1380px] gap-14 px-4 sm:px-6 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24 lg:px-8">
          <motion.div {...fadeIn} className="lg:sticky lg:top-24 lg:self-start">
            <p aria-hidden="true" className="mb-4 text-xs font-bold tracking-[0.12em] text-[#aa7e28]">الدعم والمساعدة</p>
