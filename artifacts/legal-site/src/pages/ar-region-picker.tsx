...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "يخدم كاونسلو العملاء في المملكة العربية السعودية (وفق النظام السعودي بما فيه إصلاحات رؤية 2030) وسوريا (وفق القانون المدني والتجاري السوري). الاستشارات تتم عبر الإنترنت، فيمكن لأي شخص في أي مكان الاستشارة حول مسائل قانونية في أي من البلدين." },
    },
    {
      "@type": "Question",
...
const FAQS = [
  ...
  { q: "ما الدول التي يخدمها كاونسلو؟", a: "نخدم المملكة العربية السعودية (النظام السعودي ورؤية 2030) وسوريا (القانون المدني والتجاري السوري). الاستشارات تتم عبر الإنترنت دون الحاجة لزيارة مكتب." },
