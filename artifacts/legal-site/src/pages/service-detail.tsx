        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8">
            ...
            >
              ...
              <h2 className="text-3xl font-serif font-bold text-foreground mb-8 border-b border-border pb-4">What We Cover</h2>
              ...
              <h2 className="text-3xl font-serif font-bold text-foreground mb-8 border-b border-border pb-4">Our Process</h2>
          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <Link href={`/contact?service=${id}`}>
                <Button className="w-full py-6 text-lg rounded-none bg-white text-primary hover:bg-white/90">
