...
export default function ContractsSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/contracts" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "contract-drafting": {
      ...
      descAr: "صياغة العقود ومراجعتها القانونية في المملكة العربية السعودية — عقود ثنائية اللغة وتحليل المخاطر ومشورة في قابلية التنفيذ. استشارة أونلاين 24/7.",
    ...
    "contract-disputes": {
      ...
      descAr: "محامي نزاعات العقود والإخلال بالعقد في المملكة — التقاضي والوساطة واسترداد التعويضات أمام المحاكم التجارية السعودية. استشارة أونلاين 24/7.",
    ...
    "government-contracts": {
      ...
      descAr: "محامي عقود حكومية ومناقصات في المملكة — نزاعات المناقصات ومطالبات الإخلال الحكومي وإجراءات ديوان المظالم. استشارة أونلاين 24/7.",
    ...
    "real-estate-contracts": {
      ...
      descAr: "محامي عقود عقارية في المملكة العربية السعودية — صياغة عقود البيع والشراء والإيجار والبناء وحسم النزاعات. استشارة أونلاين 24/7.",
    ...
    "employment-contracts": {
      ...
      descAr: "محامي عقود عمل في المملكة العربية السعودية — صياغة ومراجعة وإخلال عقد العمل والتمثيل أمام المحاكم العمالية السعودية. استشارة أونلاين 24/7.",
    ...
    "partnership-agreements": {
      ...
      descAr: "محامي اتفاقيات الشراكة والمشاريع المشتركة في المملكة — الصياغة والتفاوض ومطالبات الإخلال والتصفية. استشارة أونلاين 24/7.",
    ...
    "international-contracts": {
      ...
      descAr: "محامي العقود الدولية وعابرة الحدود في المملكة — القانون الواجب التطبيق والاختصاص القضائي وإنفاذ الأحكام الأجنبية. استشارة أونلاين 24/7.",
    ...
    "contract-enforcement": {
      ...
      descAr: "محامي إنفاذ العقود والتزامات الأداء في المملكة — التنفيذ العيني وأوامر الحظر والتعويضات والإنفاذ أمام المحاكم السعودية. استشارة أونلاين 24/7.",
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/contracts/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/contracts" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
