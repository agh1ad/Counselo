...
export default function TaxZakatSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/tax-zakat" className="text-primary hover:underline">{cd.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    "vat-compliance": {
      ...
      descAr: "محامي ضريبة القيمة المضافة في المملكة — امتثال ضريبة القيمة المضافة ونزاعات وتقديرات الهيئة. استشارة أونلاين 24/7.",
    ...
    "zakat-disputes": {
      ...
      descAr: "محامي نزاعات زكاة في المملكة — الاعتراض على تقديرات الزكاة وحسم نزاعاتها مع هيئة الزكاة والضريبة. استشارة أونلاين 24/7.",
    ...
    "zatca-appeals": {
      ...
      descAr: "محامي استئناف هيئة الزكاة في المملكة — التمثيل أمام لجنة تسوية النزاعات الضريبية والمحاكم الإدارية. استشارة أونلاين 24/7.",
    ...
    "corporate-tax": {
      ...
      descAr: "محامي ضريبة الدخل على الشركات في المملكة — الامتثال الضريبي وتدقيق الهيئة ونزاعات التقديرات. استشارة أونلاين 24/7.",
    ...
    "transfer-pricing": {
      ...
      descAr: "محامي تسعير تحويلي في المملكة — توثيق التسعير التحويلي ومواجهة تدقيقات الهيئة وحسم نزاعاتها. استشارة أونلاين 24/7.",
    ...
    "customs-disputes": {
      ...
      descAr: "محامي نزاعات جمركية في المملكة — رسوم جمركية ونزاعات التصنيف الجمركي وغرامات الجمارك مع هيئة الزكاة. استشارة أونلاين 24/7.",
    ...
    "tax-advisory": {
      ...
      descAr: "محامي استشارات ضريبية في المملكة — تخطيط ضريبي للأعمال وتحسين الهياكل ومزايا المناطق الاقتصادية. استشارة أونلاين 24/7.",
    ...
    "excise-tax": {
      ...
      descAr: "محامي ضريبة انتقائية في المملكة — الامتثال للضريبة الانتقائية وتدقيقات الهيئة ونزاعات تقديراتها. استشارة أونلاين 24/7.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: isRTL ? "الزكاة والضريبة" : "Tax & Zakat Law", item: "https://qanoni.com/services/tax-zakat" },
      { "@type": "ListItem", position: 4, name: data.title, item: `https://qanoni.com/services/tax-zakat/${subId}` },
    ],
  };
  ...
  const legalServiceSchema = {
    ...
    url: `https://qanoni.com/services/tax-zakat/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/tax-zakat" className="hover:text-primary transition-colors">{cd.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
      ...
      <section className="relative py-16 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/services/tax-zakat" className="inline-flex items-center text-white/60 hover:text-white text-sm mb-8 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: isRTL ? -20 : 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sticky top-28 space-y-6">
              ...
              <div className="bg-card border border-border p-6">
                ...
                <div className="space-y-1">
                  {otherAreas.map((area) => (
                    <Link key={area.id} href={`/services/tax-zakat/${area.id}`} className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-primary/5 hover:text-primary transition-colors group text-sm">
