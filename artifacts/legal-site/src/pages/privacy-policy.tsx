...
export default function PrivacyPolicy() {
  ...
  const content = {
      ...
      sections: [
        ...
        },
        {
          ...
          list: [
            ...
            "To exercise any of these rights, contact us via email at bagdadio@gmail.com — we will respond within 30 days",
          ],
        },
        {
          icon: Shield,
    ...
    ar: {
      seoTitle: "سياسة الخصوصية | كيف يحمي قانوني بياناتك | قانوني",
      seoDesc:
        "سياسة الخصوصية لمنصة قانوني — كيف نجمع بياناتك الشخصية ومعلوماتك القانونية ونحميها. سرية مهنية صارمة في جميع الاستشارات. منصة الاستشارات القانونية الأونلاين في المملكة العربية السعودية.",
      canonical: "/privacy-policy",
      eyebrow: "حماية البيانات والخصوصية",
      heading: "سياسة الخصوصية",
      subheading:
        "تلتزم منصة قانوني بحماية خصوصيتك وسرية معلوماتك القانونية. توضّح هذه السياسة البيانات التي نجمعها وكيفية استخدامها والضمانات الصارمة التي تحكم كل ما تشاركنا إياه.",
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "تخضع جميع المعلومات التي تشاركها مع قانوني لسرية مهنية صارمة — وهي ذات الامتياز المكفول بين المحامي وموكله الذي يحكم جميع الممارسات القانونية في المملكة العربية السعودية. ويعني ذلك:",
          list: [
            "لن نُفصح أبداً عن تفاصيل قضيتك القانونية أو مستنداتك أو معلوماتك الشخصية لأي طرف ثالث دون موافقتك الخطية الصريحة",
            "لا يطّلع على معلوماتك إلا أعضاء الفريق القانوني في قانوني المعنيّون مباشرةً بمعالجة استشارتك",
        ...
        },
        {
          ...
          list: [
            ...
            "تُعامَل جميع محتويات الاستشارة التي يتلقّاها قانوني عبر أي قناة كانت بسرية تامة بصرف النظر عن أسلوب الإرسال",
        ...
        },
        {
          ...
          list: [
            ...
            "لممارسة أي من هذه الحقوق، تواصل معنا عبر البريد الإلكتروني bagdadio@gmail.com — سنردّ خلال 30 يوماً",
          ],
        },
        {
          icon: Shield,
          ...
          list: [
            "يقتصر الوصول إلى ملفات الاستشارة على أعضاء الفريق القانوني المخوَّلين في قانوني حصراً",
        ...
        },
        {
          ...
          list: [
            ...
            "يُعدّ استمرار استخدامك لخدمات قانوني بعد أي تحديث قبولاً للسياسة المعدَّلة",
          ],
        },
      ],
