...
export default function FamilyLawSub() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <Link href="/services/family-law" className="text-primary hover:underline">{rel.notFoundLink}</Link>
        </div>
      </div>
    );
  }
  ...
  const SEO_DATA: Record<string, { desc: string; descAr: string; kw: string; kwAr: string }> = {
    ...
    "khul": {
      desc: "Khul divorce consultation in Saudi Arabia — court process, mahr refund & wife's rights under Personal Status Law. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "alimony": {
      desc: "Alimony & child support legal consultation in Saudi Arabia — nafaqah calculation, court orders & enforcement rights. Professional response within 24 hours via WhatsApp or email — Qanoni Saudi Arabia.",
    ...
    "child-custody": {
      desc: "Child custody legal advice in Saudi Arabia — custody rights, visitation orders & enforcement under Saudi Personal Status Law. Professional response within 24 hours via WhatsApp or email — Qanoni.",
    ...
    "inheritance": {
      desc: "Inheritance dispute & estate distribution legal advice in Saudi Arabia — Sharia law, court claims & heirs' rights. Professional response within 24 hours via WhatsApp — Qanoni Saudi Arabia.",
    ...
    "marriage-contract": {
      desc: "Marriage contract drafting & enforcement in Saudi Arabia — prenuptial conditions, mahr agreements & legal validity. Professional response within 24 hours via WhatsApp or email — Qanoni.",
  ...
  const legalServiceSchema = {
    ...
    "url": `https://qanoni.com/services/family-law/${subId}`,
      ...
      <div className="bg-card border-b border-border py-4 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
            ...
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
            <Link href="/services/family-law" className="hover:text-primary transition-colors">{rel.breadcrumb.parent}</Link>
            <ChevronRight className={`h-3.5 w-3.5 shrink-0 ${isRTL ? "rotate-180" : ""}`} />
