    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full" style={{ background: "radial-gradient(ellipse at 70% 50%, hsl(38 80% 20% / 0.35) 0%, transparent 70%), linear-gradient(135deg, hsl(220 30% 8%) 0%, hsl(220 25% 12%) 100%)" }} />
          ...
          <div className="max-w-3xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-serif font-bold text-white leading-tight mb-6">
                Clarity in <span className="text-primary italic">Complexity</span>.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact">
                  <Button size="lg" className="text-lg px-8 py-6 rounded-none w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90">
                    Book a Consultation
                  </Button>
                </Link>
                <Link href="/services">
                  <Button size="lg" variant="outline" className="text-lg px-8 py-6 rounded-none w-full sm:w-auto border-primary text-primary hover:bg-primary/10">
                    Explore Services
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeIn}>
              <h2 className="text-4xl font-serif font-bold text-white mb-6">Modern Counsel. <br/>Traditional Excellence.</h2>
            ...
            >
              <div className="aspect-[4/5] relative">
                <div className="w-full h-full rounded-sm shadow-2xl" style={{ background: "linear-gradient(135deg, hsl(220 25% 15%) 0%, hsl(220 20% 10%) 50%, hsl(38 60% 18%) 100%)" }} />
                <div className="absolute -bottom-6 -left-6 w-48 h-48 bg-secondary border border-border p-6 flex flex-col justify-center shadow-xl">
                  <span className="text-4xl font-serif text-primary font-bold mb-2">25+</span>
                  <span className="text-muted-foreground font-medium uppercase tracking-widest text-sm">Years of<br/>Combined<br/>Experience</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-serif font-bold text-white mb-4">Our Practice Areas</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="group bg-background border border-border p-8 hover:border-primary/50 transition-colors"
              >
                <h3 className="text-xl font-serif font-bold text-white mb-4 group-hover:text-primary transition-colors">{service.title}</h3>
          ...
          <div className="mt-12 text-center">
            <Link href="/services">
              <Button variant="outline" className="border-primary text-primary hover:bg-primary/10 rounded-none px-8">
                View All Services
              </Button>
            </Link>
          </div>
      ...
      <section className="py-24 bg-background border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="mb-16">
            <h2 className="text-4xl font-serif font-bold text-white mb-4">The Lexora Advantage</h2>
      ...
      <section className="py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-serif font-bold text-white mb-4">Client Perspectives</h2>
            <div className="w-20 h-1 bg-primary mx-auto mb-6" />
          </motion.div>
      ...
      <section className="py-24 relative overflow-hidden bg-background border-t border-border">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div {...fadeIn}>
            ...
            <Link href="/contact">
              <Button size="lg" className="text-lg px-12 py-8 rounded-none bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_40px_rgba(202,138,4,0.3)]">
