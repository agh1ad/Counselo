export const en = {
  ...
  home: {
    hero: {
      ...
      h1a: "Legal Help.",
      h1b: "Fast, Reliable & Professional.",
      desc: "Adlix delivers professional online legal consultations across",
      descBold: "Saudi Arabia",
      descEnd: "— for individuals, businesses and investors.",
      subDesc: "Book instantly via WhatsApp, email or video session. Available in Arabic and English.",
