      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
              ...
              <AnimatePresence>
                {servicesOpen && (
                  <motion.div
                    ...
                    className="absolute left-0 mt-2 w-56 bg-card border border-border shadow-lg py-2"
                  >
            ...
            <Link href="/contact">
              <Button className="font-medium">Book Consultation</Button>
            </Link>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              <Link href="/" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-white hover:text-primary">Home</Link>
              <div className="px-3 py-2 text-base font-medium text-white">Services</div>
              ...
              <Link href="/contact" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-white hover:text-primary">Contact</Link>
