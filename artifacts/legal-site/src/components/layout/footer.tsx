        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              <span className="font-serif text-2xl font-bold tracking-tight text-white">Lexora <span className="text-primary">Legal</span></span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li><Link href="/services/family-law" className="hover:text-primary transition-colors">Family Law</Link></li>
              <li><Link href="/services/business-law" className="hover:text-primary transition-colors">Business & Corporate</Link></li>
              <li><Link href="/services/criminal-defense" className="hover:text-primary transition-colors">Criminal Defense</Link></li>
              <li><Link href="/services/real-estate" className="hover:text-primary transition-colors">Real Estate Law</Link></li>
              <li><Link href="/services/immigration" className="hover:text-primary transition-colors">Immigration Law</Link></li>
            </ul>
          </div>
