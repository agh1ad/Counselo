...
export const staticBlogPosts: BlogPost[] = [
  {
    ...
    en: {
      ...
      seoTitle:
        "Divorce in Saudi Arabia: Legal Rights & Process | Online Family Law Consultation | CounselO",
      seoDescription:
    ...
    ar: {
      ...
      seoTitle:
        "الطلاق في المملكة العربية السعودية: الحقوق القانونية والإجراءات | استشارة قانونية أونلاين | كاونسلو",
      seoDescription:
      ...
      content: [
        ...
        },
        {
          ...
          body: "تنطوي قضايا الأسرة على متطلبات إجرائية دقيقة تؤثر بشكل مباشر على النتيجة. يُنصح بشدة باستشارة محامي أسرة متخصص قبل أي خطوة رسمية. يقدم كاونسلو استشارات سرية عبر واتساب أو البريد الإلكتروني دون الحاجة لحضور مكتب.",
        },
      ],
    },
  },
  {
    ...
    en: {
      ...
      seoTitle:
        "Wrongful Termination Saudi Arabia: Employee Rights | Saudi Labor Law Lawyer | CounselO",
      seoDescription:
    ...
    ar: {
      ...
      seoTitle:
        "الفصل التعسفي في المملكة: حقوق الموظف ونظام العمل السعودي | محامي عمل | كاونسلو",
      seoDescription:
      ...
      content: [
        ...
        },
        {
          ...
          body: "احتفظ بجميع الأدلة: عقد العمل والمراسلات والتقارير الوظيفية. لا توقع أي تسوية أو تنازل قبل الحصول على مشورة قانونية مستقلة — يقدم كاونسلو استشارة عمالية سرية عبر واتساب أو البريد الإلكتروني خلال دقائق.",
        },
      ],
    },
  },
  ...
  },
  {
    ...
    en: {
      ...
      seoTitle:
        "Board of Grievances Saudi Arabia: How to File & Win | Administrative Law Lawyer | CounselO",
      seoDescription:
        "Learn how the Board of Grievances (Diwan Al-Mazalim) works in Saudi Arabia. Types of cases, filing deadlines, and what to expect. Expert administrative law consultation — CounselO.",
      content: [
        {
    ...
    ar: {
      ...
      seoTitle:
        "ديوان المظالم في المملكة العربية السعودية: كيفية الرفع والفوز | محامي إداري | كاونسلو",
      seoDescription:
        "تعرف على آلية عمل ديوان المظالم في المملكة العربية السعودية — أنواع القضايا ومواعيد التقديم. استشارة قانونية إدارية متخصصة مع كاونسلو.",
      content: [
        {
  ...
  },
  {
    ...
    en: {
      ...
      seoTitle:
        "Real Estate Disputes Saudi Arabia: Legal Rights & Remedies | Property Lawyer | CounselO",
      seoDescription:
        "Facing a real estate dispute in Saudi Arabia? Learn your legal options — title disputes, contractor defects, rental disputes, and more. Expert Saudi property law consultation with CounselO.",
      content: [
        {
    ...
    ar: {
      ...
      seoTitle:
        "النزاعات العقارية في المملكة: الحقوق القانونية وسبل الإنصاف | محامي عقارات | كاونسلو",
      seoDescription:
        "هل تواجه نزاعاً عقارياً في المملكة العربية السعودية؟ تعرف على خياراتك القانونية — نزاعات الملكية وعيوب البناء والإيجار. استشارة قانونية عقارية متخصصة مع كاونسلو.",
      content: [
        {
  ...
  },
  {
    ...
    en: {
      ...
      seoTitle:
        "Child Custody Saudi Arabia: Rights & Court Process | Family Law Lawyer | CounselO",
      seoDescription:
        "Understand how Saudi Arabian courts decide child custody — Hadhanah, Wilayah, and the best interests of the child. Expert online family law consultation with CounselO. 30+ years experience.",
      content: [
        {
    ...
    ar: {
      ...
      seoTitle:
        "الحضانة في المملكة العربية السعودية: الحقوق وإجراءات المحكمة | محامي أسرة | كاونسلو",
      seoDescription:
        "تعرف على كيفية بت المحاكم السعودية في قضايا الحضانة — الحضانة والولاية ومصلحة المحضون. استشارة قانونية أسرية أونلاين مع كاونسلو. خبرة 30+ عاماً.",
      content: [
        {
